...
from .views import (
    ...
    EcheancierPaiementViewSet, EcheanceViewSet, TarifActeViewSet, BordereauAssuranceViewSet,
)
...
router.register(r'bordereaux-assurance', BordereauAssuranceViewSet, basename='bordereau-assurance')
